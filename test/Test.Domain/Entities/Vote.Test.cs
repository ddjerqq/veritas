...
//         var vote = Vote.TryCreate(voter, 5, _time.UtcNowUnixTimeMilliseconds);
//
...
//     {
//         var voter = Voter.NewVoter();
//         var vote = Vote.TryCreate(voter, 0, _time.UtcNowUnixTimeMilliseconds);
//
//         var voteDto = (VoteDto)vote;
...
//         var vote = Vote.TryCreate(Voter.NewVoter(), 0, timestamp);
...
//     {
//         var vote = Vote.TryCreate(Voter.NewVoter(), 0, 0)!;
